...
router.get('/class/:className/students/summary', protect, isTeacher, teacherController.getStudentsWithAttendance);
router.get("/class/:className/students",protect,isTeacher,teacherController.getStudentsByClassAndTimetable);
